...
namespace MarcoApps.VpcSkillTest.Services.Api.Migrations
{
    ...
    [Migration("20241231184759_UpdateInventarios")]
    partial class UpdateInventarios
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarcoApps.VpcSkillTest.Services.Api.Models.Instalacion", b =>
                {
                    ...
                    b.Property<int>("MecanicoInstalaId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MarcoApps.VpcSkillTest.Services.Api.Models.Instalacion", b =>
                {
                    b.HasOne("MarcoApps.VpcSkillTest.Services.Api.Models.Mecanico", "MecanicoInstala")
                        .WithMany()
                        .HasForeignKey("MecanicoInstalaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
